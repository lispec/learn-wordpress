...
function thinkup_input_homepagesection()
{
    ...
    if (is_front_page() or thinkup_check_ishome()) {
        if (empty($thinkup_homepage_sectionswitch) or $thinkup_homepage_sectionswitch == '1') {
            ...
            echo '<p><a href="#"><img src="/wp-content/uploads/2016/05/banner-300x115.jpg" class="my1"/></a></p>';
            echo '<p><a href="#"><img src="/wp-content/uploads/2016/05/banner-300x115.jpg" class="my2"/></a></p>';
            echo '<p><a href="#"><img src="/wp-content/uploads/2016/05/banner-300x115.jpg" class="my3"/></a></p>';
            echo '<p><a href="#"><img src="/wp-content/uploads/2016/05/banner-300x115.jpg" class="my4"/></a></p>';
            echo '<p><a href="#"><img src="/wp-content/uploads/2016/05/banner-300x115.jpg" class="my2"/></a></p>';
            echo '<p><a href="#"><img src="/wp-content/uploads/2016/05/banner-300x115.jpg" class="my1"/></a></p>';
...
//            echo '<ul style="border:1px solid black; padding:0">';
//            echo '<li>Инлайн Блок<br>3 строки<br>высота/ширина явно не заданы</li>';
//            echo '<li style="width:100px;height:100px">Инлайн<br>Блок 100x100</li>';
//            echo '<li style="width:60px;height:60px">Инлайн<br>Блок 60x60</li>';
//            echo '<li style="width:100px;height:60px">Инлайн<br>Блок 100x60</li>';
//            echo '<li style="width:60px;height:100px">Инлайн<br>Блок 60x100</li>';
//            echo '</ul>';

            echo '<ul style="border:1px solid black; padding:0">';
            echo '<li><a href="#"><img src="/wp-content/uploads/2016/05/banner-300x115.jpg" class="my1"/></a></li>';
            echo '<li style="width:100px;height:100px"><a href="#"><img src="/wp-content/uploads/2016/05/banner-300x115.jpg" class="my1"/></a></li>';
            echo '<li style="width:60px;height:60px"><a href="#"><img src="/wp-content/uploads/2016/05/banner-300x115.jpg" class="my1"/></a></li>';
            echo '<li style="width:100px;height:60px"><a href="#"><img src="/wp-content/uploads/2016/05/banner-300x115.jpg" class="my1"/></a></li>';
            echo '<li style="width:60px;height:100px"><a href="#"><img src="/wp-content/uploads/2016/05/banner-300x115.jpg" class="my1"/></a></li>';
            echo '</ul>';
...
function thinkup_input_ctaintro()
{
    ...
    if ($thinkup_homepage_introswitch == '1' and (is_front_page() or thinkup_check_ishome()) and !empty($thinkup_homepage_introaction)) {
        ...
        if ((!empty($thinkup_homepage_introactionlink1) and $thinkup_homepage_introactionlink1 !== 'option3')) {
            ...
            if (empty($thinkup_homepage_introactiontext1)) {
                $thinkup_homepage_introactiontext1 = 'Read More';
            }
