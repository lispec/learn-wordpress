...
function thinkup_input_footerw1() {
	...
	echo	'<h3 class="widget-title">' . __( 'Please Add Widgets', 'sento') . '</h3>',
			...
			'<a href="/wp-admin/widgets.php" title="' . __( 'No Widgets Selected', 'sento' ) . '">' . __( 'Click here to go to Widget area.', 'sento') . '</a>',
			'</div>';
	};
	echo	'</div>';
}
...
function thinkup_input_copyright() {
	...
	printf( __( 'Developed by %1$s. Powered by %2$s.', 'sento' ) , '<a href="//www.andrew-vorobyov.tk/" target="_blank">Andrew</a>', '<a href="//www.wordpress.org/" target="_blank">My first WordPress</a>');
}
